...
class Collector:
    def __init__(self,logger):
        ...
        self.logger = logger
        if not os.path.exists('src/maria_piv/static'):
            os.makedirs('src/maria_piv/static')
        if not os.path.exists('src/maria_piv/static/data'):
            os.makedirs('src/maria_piv/static/data')
